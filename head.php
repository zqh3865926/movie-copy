...
<!--	  	gtag('js', new Date());-->
<!--	-->
<!--	  	gtag('config', 'UA-138875328-4');-->
<!--		var _hmt = _hmt || [];-->
<!--		(function() {-->
<!--		  var hm = document.createElement("script");-->
<!--		  hm.src = "https://hm.baidu.com/hm.js?2a082bb5cde6292851e66a63ee1595e1";-->
	...
	<div id="content">
	    <div class="search">
	       <form action="search.php" method="GET">
	        <input type="text" name="v" id="wd" placeholder="<?php if(empty($_GET['v'])){ echo '输入关键词';}else{echo $_GET['v'];} ?>" value="<?php echo $_GET['v']; ?>" autocomplete="off">
